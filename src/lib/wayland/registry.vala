namespace TogetherShell { // TODO : library, static/const listeners, etc..
    [SingleInstance]
    public class Registry : Object {
        ...
        public Wl.Display display = new Wl.Display.connect (Environ.get_variable (null, "WAYLAND_DISPLAY"));
