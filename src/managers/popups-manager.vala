namespace TogetherShell {
    ...
    public class PopupsManager : Object {
        ...
        private Gee.ArrayList<TogetherWayfire.Binding> bindings = new Gee.ArrayList<TogetherWayfire.Binding> ();
        ...
        public PopupsManager () {
            ...
            var volume_up_bind = new TogetherWayfire.Binding ("KEY_VOLUMEUP", false, TogetherWayfire.BindingMode.REPEAT);
            volume_up_bind.triggered.connect (() => { wireplumber.default_speaker.volume += 0.05; });
            var volume_down_bind = new TogetherWayfire.Binding ("KEY_VOLUMEDOWN", false, TogetherWayfire.BindingMode.REPEAT);
